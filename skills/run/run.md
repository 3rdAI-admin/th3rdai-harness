...
## Optional harness route driver

Some deployments include a CLI that sequences lifecycle routes (dry-run by default; opt-in execution). If `scripts/orchestrate.py` exists, see **Optional Native Orchestrator** in `_config/project-notes.md` — do not assume every project has it.
